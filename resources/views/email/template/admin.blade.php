            ...
            <table class="dark-bg" align="center" border="0" cellpadding="0" cellspacing="0" width="570"
                ...
                <tr class="dark-bg"
                    ...
                    <td width="100%">
                        ...
                        <td>
                        <![endif]-->
                            <a href="https://bizlabitsolutions.com" target="_blank" class="btn-white"
                ...
                <tr>
                    <td class="dark-bg-base"
                        ...
                        <div style="padding-top: 10px;padding-bottom: 10px;">
                            ...
                            font-family: Verdana, Geneva, Tahoma, sans-serif;">© {{ date('Y') }} BizLab IT Solutions, All Rights Reserved
                            </p>
